...
LS-05 | At the top right-hand corner of the Velux window (the corner in closest proximity to the Building Owner's side), a hairline crack extends approximately 250mm upward toward the ridge before bifurcating. One branch extends horizontally toward the dormer cheek, continuing to the junction with the pitched roof slope. A second branch traces into the Velux reveal, running along the junction of the head and right-hand side reveal and terminating at the frame abutment. Refer to photographs. | Record pre-existing defect. To be monitored during and following notifiable works.
...
FR-03 | A complex pattern of cracking is recorded to the face of the chimney breast: (i) a vertical and diagonal crack extending from the top left-hand corner downward toward a mirror fitting; (ii) a vertical crack to the right of the mirror, extending upward and branching toward the front elevation; (iii) two horizontal cracks extending from behind the mirror toward the fitted wardrobe, with a vertical branch extending downward; and (iv) a further horizontal crack to the left of the mirror, with branches extending both upward and downward. | Record pre-existing defect. Extent photographically recorded.
...
FR-06 | Above the desk, a horizontal crack extends outward from the party wall and branches upward at the far end of the desk. | Record pre-existing defect
...
GR-01 | Full-width sliding doors to the rear elevation were tested and operated satisfactorily without sticking, binding or impediment. The locking mechanism operated correctly. No visible defects were noted to the glazing, frames or threshold. | Record only
GR-02 | An open joint is present between the floor tiling and the base of the sliding door frame along the full width of the threshold. | Record pre-existing defect
GR-03 | The property has been extended to the rear. Structural beams are present but concealed within the wall and ceiling construction. Technical confirmation is required as to whether sequential excavation and underpinning is necessary in connection with the proposed foundation works. | Further investigation required — see Discussion Items
