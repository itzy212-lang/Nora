...
export default function MainChat({ onOpenComposer, onClose }) {
  ...
  const closeToDashboard = useCallback(() => {
    ...
    /*
      Fallback for the current app wiring:
      If MainChat has been opened without an onClose prop, hiding the overlay leaves
      a blank grey screen. A hard navigation to "/" reliably returns the app to the
