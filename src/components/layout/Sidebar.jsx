              ...
              return (
                <div
                  ...
                  style={{
                    ...
                    padding: '9px 16px', fontSize: 13.5, fontWeight: active ? 500 : 400,
                ...
                >
                  ...
                  {count > 0 && (
                    <span style={{
                      background: 'var(--red)', color: '#fff', fontSize: 10.5,
                      fontWeight: 600, padding: '1px 6px', borderRadius: 99, minWidth: 18,
                      textAlign: 'center',
                    }}>
                      {count}
                    </span>
