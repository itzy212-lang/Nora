...
export default function DraftWithEly({ email, threadId, projectId, onUseDraft, onClose }) {
  ...
  }, [input, loading, send, sessionId, email, threadId, projectId]);
  ...
  return (
    <div className="draft-ely-panel" onClick={(e) => { if (e.target === e.currentTarget) onClose(); }}>
      <div className="draft-ely-inner">
        ...
        <div className="draft-ely-input">
          <div className="draft-ely-input-row">
            <VoiceInput
              onTranscript={(t) => { setInput(prev => prev ? prev + ' ' + t : t); textareaRef.current?.focus(); }}
              disabled={loading}
            />
            <textarea
              ref={textareaRef}
